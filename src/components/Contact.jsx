  ...
  return (
    <div id='contact' className="contact-container container-fluid">
      <div className="row">
        ...
        <div className="col-md-4 p-4 form-section d-none d-md-flex">
        ...
        {/* Middle Info Section - Hide on small screens */}
        <div className="col-md-4 p-4 text-light info-section d-none d-md-block">
          <div>
        ...
        {/* Right Google Maps Section - Always visible */}
        <div className="col-md-4 col-12 p-0 map-section">
          <iframe
